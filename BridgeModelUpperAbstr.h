...
#ifndef ATLFORMULACHECKER_BRIDGEMODELUPPERABSTR_H
#define ATLFORMULACHECKER_BRIDGEMODELUPPERABSTR_H
...
//        HISTORY_TYPE history;
        ...
        State(const HANDS_TYPE &hands, const LEFTS_TYPE &lefts, char next,
              const BOARD_TYPE &board, char beginning, char clock, char suit);
...
public:
    BridgeModelUpperAbstr(int noCardsAvailable, int noEndCards, State firstState, std::string outputFileName,
    ...
    HANDS_TYPE generatedFirstState;
};


#endif //ATLFORMULACHECKER_BRIDGEMODELUPPERABSTR_H
